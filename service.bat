...
if "%menu_choice%"=="7" goto service_check_updates
...
set "listFile=%~dp0lists\ipset-all.txt"
set "url=https://raw.githubusercontent.com/mreliseyyt/zapret-config/refs/heads/main/service/ipset-service.txt"
...
set "hostsUrl=https://raw.githubusercontent.com/mreliseyyt/zapret-config/refs/heads/main/service/hosts"
